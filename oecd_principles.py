...
# Page configuration
st.set_page_config(
    page_title="OECD Principles - TUM",
    page_icon="🎓",
    layout="wide",
...
def create_navigation():
    ...
    <div class="navbar">
        <div class="nav-links">
            ...
            <span class="nav-divider"></span>
            <span class="nav-link active">OECD Principles</span>
            <span class="nav-divider"></span>
...
def main():
    ...
    <div class="page-content">
        <h1 class="page-title">OECD AI Principles</h1>
        <p class="page-description">
            Explore the OECD AI Principles that guide ethical AI development and implementation.
        </p>
    </div>
    """, unsafe_allow_html=True)
