...
# Page configuration
st.set_page_config(
    page_title="AI Ethics Scenarios - TUM",
    page_icon="🎓",
    layout="wide",
...
def main():
    ...
    <div class="page-content">
        <h1 class="page-title">AI Ethics Scenarios</h1>
        <p class="page-description">
            Engage with real-world scenarios that challenge your understanding of AI ethics and decision-making.
        </p>
    </div>
    """, unsafe_allow_html=True)
