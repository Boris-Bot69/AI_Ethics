...
def create_navigation():
    ...
    <div class="navbar">
        <div class="nav-links">
            ...
            <span class="nav-divider"></span>
            <span class="nav-link active">Research</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
def main():
    ...
    <div class="page-content">
        ...
        <p class="page-description">
            Discover the latest research and publications in AI ethics literacy and educational technology.
        </p>
    </div>
    """, unsafe_allow_html=True)
